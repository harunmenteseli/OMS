...
<head>
	...
	<title>Kasa Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Kasa Ekle</h4>
								</div>
								<div class="card-body">
									<?php 
...
<div class="row">
 ...
 <input type="text" id="ad" class="form-control" placeholder="Kasa Adı" name="kasaadi">
                                                  </div>
                                            </div>
                                            <!--/span-->
 ...
 <input type="text" id="tarih" class="tarih form-control" placeholder="İşlem Tarihi" name="acilistarihi" value="<?php echo date('Y-m-d H:i'); ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
   ...
   <label class="control-label">Açıklama</label>
		...
		<input type="hidden" class="form-control" name="kasaekle">
