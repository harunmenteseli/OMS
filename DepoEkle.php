...
<head>
	...
	<title>Depo Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Depo Ekle</h4>
								</div>
								<div class="card-body">
						<?php 
...
<div class="row">
 ...
 <input type="text" id="ad" class="form-control" placeholder="Depo Adı" name="depoadi">
                                                  </div>
                                            </div>
                                            <!--/span-->
