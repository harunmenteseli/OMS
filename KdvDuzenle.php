...
<head>
	...
	<title><?= $sonuc["kdvorani"] ?> KDV Oranını Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $sonuc["kdvorani"] ?> KDV Oranını Düzenle</h4>
								</div>
								<div class="card-body">
							<?php 
...
<div class="row">
 ...
 <input type="text" id="kdvorani" class="form-control" placeholder="KDV Oranı Adı" name="kdvorani" value="<?= $sonuc["kdvorani"] ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
