...
<head>
	...
	<title><?= $sonuc["markaadi"] ?> Markasını Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $sonuc["markaadi"] ?> Markasını Düzenle</h4>
								</div>
								<div class="card-body">
					<?php 
...
<div class="row">
 ...
 <input type="text" id="markaadi" class="form-control" placeholder="Marka Adı" name="markaadi" value="<?= $sonuc["markaadi"] ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
	...
	<input type="hidden" class="form-control" name="markaduzenle">
