...
$adres = str_replace("../","",$uploadfolder); // Dosyanın yükleneceği klasörü yolunu yazıyoruz.
        ...
        if (in_array($file['type'], $formats)) {
            ...
            echo '<span class="input-group-text" id="username-addon"  data-toggle="modal" data-backdrop="false" data-target="#kisiSeciciPencere">Resim Yükle</span><input class="form-control" id="resmi" name="resmi" placeholder="Resmi" value="'.$adres.'/'.$filename.'">'; // İşlem başarılı ise sonucu ekrana yazdırıyoruz.
        }else{
