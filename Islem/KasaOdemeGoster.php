							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												<p class="card-category">KASA ADI</p>
												<h4 class="card-title text-warning">
													<?php 
                                                      $kasa = $baglanti->query("SELECT * FROM Kasalar where id=".$sonuc["kasaadi"])->fetchAll(PDO::FETCH_ASSOC);
                                                ...
                                                ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach($kasa as $kasasi){
                                                            ?>
                                                    
                                                     <?php echo $kasasi['kasaadi']; ?>
                                                    <?php
