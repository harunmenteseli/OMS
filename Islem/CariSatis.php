...
'depo' => $depo,
          ...
          $sqll = "INSERT INTO SatisFaturasi SET urunadi=:urunadi, adet=:adet, fiyat=:fiyat, kdvsiztoplam=:kdvsiztoplam, kdvoran=:kdvoran, kdvtutar=:kdvtutar, kdvlitoplam=:kdvlitoplam, depo=:depo;";
...
$id = $_POST["id"];					
	$durum1 = $baglanti->query("DELETE FROM SatFatBag WHERE  bilgiid=$id");
...
'parabirimi' => $parabirimi,
          ...
          $sql = "UPDATE SatFatBilgi SET cariadi=:cariadi, faturatarihi=:faturatarihi, tarih=:tarih, faturaseri=:faturaseri, faturanumarasi=:faturanumarasi, odemetipi=:odemetipi, depo=:depo, odeme=:odeme, aratoplam=:aratoplam, kdvtoplam=:kdvtoplam, geneltoplam=:geneltoplam, ekleyen=:ekleyen, parabirimi=:parabirimi WHERE id=:id;";
        $durum = $baglanti->prepare($sql)->execute($satir);
