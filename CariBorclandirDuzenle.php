...
<head>
	...
	<title>Cari Borçlandırma Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Cari Borçlandırma Düzenle</h4>
								</div>
								<div class="card-body">
...
<div class="modal fade bd-example-modal-lg" id="kisiSeciciPencere" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
                    ...
                    <table class="musteritablosu table table-head-bg-<?= $tema['arkaplan']?> table-hover mt-3">
                                                        <thead>
                                                            <tr>
