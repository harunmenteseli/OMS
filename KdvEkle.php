...
<head>
	...
	<title>KDV Oranı Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">KDV Oranı Ekle</h4>
								</div>
								<div class="card-body">
							<?php 
 if ($kbilgi["kdvekle"]==1) {?>
...
<div class="row">
 ...
 <input type="text" id="kdvorani" class="form-control" placeholder="KDV Oranı Adı" name="kdvorani">
                                                  </div>
                                            </div>
                                            <!--/span-->
