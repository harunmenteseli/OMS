				...
				<div class="page-inner">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Satış Faturası Ekle</h4>
								</div>
								<div class="card-body">
									<?php 
...
<input type="text" name="ekleyen" class="form-control" placeholder="ekleyen" readonly="readonly" value="<?= $kbilgi["id"] ?>" hidden="hidden">
         <input type="text" id="cid" name="cariadi" class="form-control" placeholder="Fatura Ünvanı" readonly="readonly" hidden="hidden"> 
<input type="text" id="parabirimi" name="parabirimi" class="form-control" placeholder="Fatura Ünvanı" readonly="readonly" hidden="hidden"> 
 <input type="text" id="unvan" class="form-control text-danger" placeholder="Fatura Ünvanı" readonly="readonly">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
<div class="row">
   ...
   <label class="control-label">Vergi No veya TCKN</label>
                                                    <input type="number" id="tc" class="form-control text-danger" placeholder="Vergi No veya TCKN" readonly="readonly">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                           <div class="col-md-6">
   ...
   <label class="control-label">Vergi Dairesi</label>
                                                    <input type="text" id="daire" class="form-control text-danger" placeholder="Vergi Dairesi" readonly="readonly">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
<div class="row">
   ...
   <label class="control-label">Adres</label>
                                                    <input type="text" id="adres" class="form-control text-danger" placeholder="Adres" readonly="readonly">
                                                  </div>
   </div>
                                            </div>
                                            <!--/span-->
...
<div class="row">
   ...
   <label class="control-label">İlçe</label>
                                                    <input type="text" id="ilce" class="form-control text-danger" placeholder="İlçe" readonly="readonly">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                           <div class="col-md-6">
   ...
   <label class="control-label">İl</label>
                                                    <input type="text" id="il" class="form-control text-danger" placeholder="İl" readonly="readonly">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
<div class="modal fade bd-example-modal-lg" id="kisiSeciciPencere" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
                    ...
                    <table class="tablo2 table table table-striped table-hover table-head-bg-<?= $tema['tablorenk']?>">
                                                        <thead>
                                                            <tr>
 <th>#</th>              
...
<?php
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" id="aratoplam" name="aratoplam" placeholder="Ara Toplam" readonly="readonly">
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" id="kdvtoplam" name="kdvtoplam" placeholder="Kdv Toplam" readonly="readonly">
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" id="geneltoplam" name="geneltoplam" placeholder="Genel Toplam" readonly="readonly">
