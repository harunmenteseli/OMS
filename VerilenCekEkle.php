...
<head>
	...
	<title>Verilen Çek Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Verilen Çek Ekle</h4>
								</div>
								<div class="card-body">
							<?php 
...
<input type="text" id="ceksenet" class="form-control" placeholder="Çek" name="ceksenet" value="cek" hidden="hidden">
	<input type="text" id="islem" class="form-control" placeholder="verilen" name="islem" value="verilen" hidden="hidden">
