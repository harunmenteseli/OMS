...
$sorgu = $baglanti->prepare("SELECT * FROM AlFatBilgi Where id=:id");
...
<head>
	...
	<title><?= $sonuc["faturaseri"] ?>-<?= $sonuc["faturanumarasi"] ?> Nolu Alış Faturasını Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Alış Faturası Düzenle</h4>
								</div>
								<div class="card-body">
									<?php 
...
<div class="row">
   ...
   <label class="control-label">Vergi No veya TCKN</label>
                                                    <input type="number" id="tc" class="form-control text-danger" readonly="readonly" placeholder="Vergi No veya TCKN" readonly="readonly" value="<?php echo $cari['verginumarasi']; ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                           <div class="col-md-6">
   ...
   <label class="control-label">Vergi Dairesi</label>
                                                    <input type="text" id="daire" class="form-control text-danger" readonly="readonly" placeholder="Vergi Dairesi" readonly="readonly" value="<?php echo $cari['dairesi']; ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
<div class="row">
   ...
   <label class="control-label">Adres</label>
                                                    <input type="text" id="adres" class="form-control text-danger" readonly="readonly" placeholder="Adres" readonly="readonly" value="<?php echo $cari['adres']; ?>">
                                                  </div>
   </div>
                                            </div>
                                            <!--/span-->
...
<div class="row">
   ...
   <label class="control-label">İlçe</label>
                                                    <input type="text" id="ilce" class="form-control text-danger" readonly="readonly" placeholder="İlçe" readonly="readonly" value="<?php echo $cari['ilce']; ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                           <div class="col-md-6">
   ...
   <label class="control-label">İl</label>
                                                    <input type="text" id="il" class="form-control text-danger" readonly="readonly" placeholder="İl" readonly="readonly" value="<?php echo $cari['il']; ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
?>
		...
		<div class="col-md-12">
			<table id="Tablom" class="table table-responsive table-head-bg-<?= $tema['tablorenk']?> table-bordered table-hovered">
                            <thead>
                            <tr>
...
<?php                                                                                                               $alfatbags = $baglanti->query("
                                                                                SELECT * FROM AlFatBag where bilgiid=".$sonuc["id"])->fetchAll();
                                                            foreach ($alfatbags as $alfatbag) {
                                                        ?> 
                                                        	
                                                        <?php 
                                                      $fatura = $baglanti->query("SELECT * FROM AlisFaturasi where id=".$alfatbag["faturaid"])->fetchAll(PDO::FETCH_ASSOC);
...
<td><button type="button" data-toggle="tooltip" class="sil btn btn-icon btn-round btn-danger"><i class="fa fa-times"></i></button></td></tr>
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" readonly="readonly" id="aratoplam" name="aratoplam" placeholder="Ara Toplam" value="<?= $sonuc["aratoplam"] ?>">
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" readonly="readonly" id="kdvtoplam" name="kdvtoplam" placeholder="Kdv Toplam" value="<?= $sonuc["kdvtoplam"] ?>">
	...
	<div class="form-group">
												...
												<input type="text" class="form-control text-danger" readonly="readonly" id="geneltoplam" name="geneltoplam" placeholder="Genel Toplam" value="<?= $sonuc["geneltoplam"] ?>">
...
<input type="hidden" class="form-control" name="alisduzenle">
