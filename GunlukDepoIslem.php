...
<head>
	...
	<title>Günlük Depo İşlem - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title table-head-bg-primary">GÜNLÜK DEPO İŞLEMLERİ</h4>
								</div>
								<div class="card-body ">
...
<th>İşlem</th> 
     ...
     <?php $sorgu = $baglanti->query("SELECT * FROM DepoTransfer where DAY(islemtarihi) = DAY(CURDATE())")->fetchAll();
