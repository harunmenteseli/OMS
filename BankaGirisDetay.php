...
<head>
	...
	<title>Banka Giriş - Çıkış Detay - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title">BANKA GİRİŞ - ÇIKIŞ LİSTESİ</h4>
								</div>
...
$sorgu = $baglanti->prepare("SELECT * FROM BankaGiris Where bankaadi=:id");
...
$kurtutarsonuc=$sonuc["tutar"]*$JSONKur[$parabirimim['kur']]['satis'];
}
?>
...
$islem = $sonuc["islem"] ;
if ($islem == "bankagirdi") {
  $adres = "BankaGirisDuzenle";
}else if ($islem == "bankacikti"){
  $adres = "BankaCikisDuzenle";
}
?>
		<?php 
 if ($kbilgi["bankagirisduzenle"]==1 or $kbilgi["bankacikisduzenle"]==1) {?>															
...
<?php }?>
		...
		<?php 
 if ($kbilgi["bankagirissil"]==1 or $kbilgi["bankacikissil"]==1) {?>
        ...
        $(document).ready(function(){
           ...
           var productId = $(this).data('id'); 	
				...
				swal({
                    ...
                    data: 'bankagirissil='+productId, // Formdaki tüm verileri al
