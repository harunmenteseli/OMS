				...
				<div class="page-inner">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $carim['unvani']?> - Alış Faturası Ekle</h4>
								</div>
								<div class="card-body">
								<?php 
...
<div class="row">
   ...
   <label class="control-label">Fatura Tarihi</label>
                                                    <input type="text" name="faturatarihi" class="tarih form-control" placeholder="Fatura Tarihi" value="<?php echo date('Y-m-d H:i'); ?>" />
                                                  </div>
                                            </div>
                                            <!--/span-->
                                           <div class="col-md-4">
