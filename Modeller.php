...
<head>
	...
	<title>Modeller - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title">MODEL LİSTESİ</h4>
								</div>
...
<button id="Kaydet" name="kaydet" type="submit" class="btn btn-success btn-raised btn-block" onclick="window.location.href='ModelEkle.php'">
Model Ekle</button>
<?php }?>
<br>
...
<?php
						...
						$sorgu = $baglanti->prepare('Select * from Modeller'); // Veritabanındaki Modeller tablosundaki tüm verileri çekiyoruz
...
<tr id="secilen" class="Satirekle">
	      <td class="sira"><?= $sonuc['id']?></td>
                    <td class="modeladi"><?= $sonuc['modeladi']?></td>
<td>
														<div class="form-button-action">
															
			<?php 
 if ($kbilgi["modelduzenle"]==1) {?>										
<button  type="button" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-round btn-warning" data-original-title="Düzenle" onclick="window.location.href='ModelDuzenle.php?id=<?= $sonuc["id"] ?>'">
        ...
        $(document).ready(function(){
           ...
           var productId = $(this).data('id'); 	
				...
				swal({
                    ...
                    data: 'modelsil='+productId, // Formdaki tüm verileri al
