...
<head>
	...
	<title><?= $sonuc["ceknumarasi"] ?> Nolu Alınan Çek Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $sonuc["ceknumarasi"] ?> Nolu Alınan Çek Düzenle</h4>
								</div>
								<div class="card-body">
						<?php 
...
<input type="text" id="ceksenet" class="form-control" placeholder="Çek" name="ceksenet" value="<?= $sonuc["ceksenet"] ?>" hidden="hidden">
	<input type="text" id="islem" class="form-control" placeholder="Alinan" name="islem" value="<?= $sonuc["islem"] ?>" hidden="hidden">

                                            <div class="col-md-12">
                                                <div class="form-group">
                                
   <label class="control-label">Çek Numarası</label>
 <input type="number" id="cekno" class="form-control" placeholder="Çek Numarası" name="ceknumarasi" value="<?= $sonuc["ceknumarasi"] ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
...
<label class="control-label">Evrak Türü</label>
            <select class="form-control custom-select" name="evrakturu" data-placeholder="Evrak Türü Seçiniz" tabindex="1">
         <option value="<?= $sonuc["evrakturu"] ?>"><?= $sonuc["evrakturu"] ?></option>
	...
	Cirolu Evrak</option>
									...
									<input type="hidden" class="form-control" name="alinancekduzenle">
