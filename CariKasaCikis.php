...
<head>
	...
	<title><?= $carim['unvani']?> - Kasa Çıkış - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $carim['unvani']?> - Kasa Çıkış</h4>
								</div>
								<div class="card-body">
									<?php 
...
<input type="text" id="evrakno" class="form-control" placeholder="Girdi" name="islem" value="kasacikti" hidden="hidden">
...
<input type="text"  id="parabirimi" hidden="hidden" name="parabirimi" value="<?= $carim['parabirimi']?>">
 ...
 <input type="text" id="tutar" class="sayi form-control" placeholder="Tutar" name="tutar">
	...
	<input type="hidden" class="form-control" name="kasagirisekle">
        ...
        $(document).ready(function(){
            $('#Ekle').submit(function(e) {
				swal({
                    ...
                    url: "Islem/CariKasa.php", // POST işleminin olacağı sayfa
