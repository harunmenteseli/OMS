...
<head>
	...
	<title>Stok Grup Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Stok Grup Ekle</h4>
								</div>
								<div class="card-body">
									<?php 
...
<div class="row">
 ...
 <input type="text" id="carigrupadi" class="form-control" placeholder="Stok Grup Adı" name="stokgrupadi">
                                                  </div>
                                            </div>
                                            <!--/span-->
	...
	<input type="hidden" class="form-control" name="stokgrupekle">
