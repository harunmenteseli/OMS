...
<head>
	...
	<title><?= $carim['unvani']?> - Kasa Giriş - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $carim['unvani']?> - Kasa Giriş</h4>
								</div>
								<div class="card-body">
									<?php 
...
<input type="text" id="evrakno" class="form-control" placeholder="Girdi" name="islem" value="kasagirdi" hidden="hidden">
