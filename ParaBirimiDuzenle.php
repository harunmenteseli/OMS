...
<head>
	...
	<title>Para Birimi Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title">Para Birimi Düzenle</h4>
								</div>
								<div class="card-body">
									<?php 
...
<div class="row">
 ...
 <input type="text" id="parabirimadi" class="form-control" placeholder="Para Birimi" name="parabirimadi" value="<?= $sonuc["parabirimadi"] ?>">
                                                  </div>
                                            </div>
                                            <!--/span-->
 <div class="col-md-12">
...
<option value="<?= $sonuc["kur"] ?>"><?= $sonuc["kur"] ?></option>
