				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $carim['unvani']?> - Çek Ekle</h4>
								</div>
								<div class="card-body">
						<?php 
...
<input type="text" id="ceksenet" class="form-control" placeholder="Çek" name="ceksenet" value="cek" hidden="hidden">
	<input type="text" id="islem" class="form-control" placeholder="Alinan" name="islem" value="verilen" hidden="hidden">
...
<label class="control-label">Evrak Türü <font color="red"> (*)</font></label>
            <select class="form-control custom-select" name="evrakturu" data-placeholder="Evrak Seçiniz" tabindex="1">
                                        ...
                                        <!--/row-->
									<input type="hidden" class="form-control" name="verilencekekle">
