...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title table-head-bg-primary">VERİLEN SENET LİSTESİ</h4>
								</div>
...
<button id="Kaydet" name="kaydet" type="submit" class="btn btn-success btn-raised btn-block" onclick="window.location.href='VerilenSenetEkle.php'">
Senet Ekle</button>
<?php }?>
	<br>
...
<th>İşlem</th> 
        ...
        <tbody id="Urunlistesi">      
                      <?php                                                                                                               $sorgu = $baglanti->query("
                                                                                SELECT * FROM CekSenet where islem='verilen' and ceksenet='senet'")->fetchAll();
...
<td>
 ...
 if ($kbilgi["verilensenetduzenle"]==1) {?>															
										<button  type="button" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-round btn-warning" data-original-title="Düzenle" onclick="window.location.href='VerilenSenetDuzenle.php?id=<?= $sonuc["id"] ?>'">
        ...
        $(document).ready(function(){
           ...
           var productId = $(this).data('id'); 	
				...
				swal({
                    ...
                    data: 'verilensenetsil='+productId, // Formdaki tüm verileri al
