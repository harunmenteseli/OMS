...
<head>
	...
	<title>Marka Ekle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="row">
 ...
 <input type="text" id="carigrupadi" class="form-control" placeholder="Marka Adı" name="markaadi">
                                                  </div>
                                            </div>
                                            <!--/span-->
			...
			<input type="hidden" class="form-control" name="markaekle">
