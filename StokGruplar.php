...
<head>
	...
	<title>Stok Gruplar - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title table-head-bg-primary">STOK GRUP LİSTESİ</h4>
								</div>
...
<button id="Kaydet" name="kaydet" type="submit" class="btn btn-success btn-raised btn-block" onclick="window.location.href='StokGrupEkle.php'">
Stok Grup Ekle</button>
<?php }?>
<br>
...
<?php
						...
						$sorgu = $baglanti->prepare('Select * from StokGruplar'); // Veritabanındaki Depolar tablosundaki tüm verileri çekiyoruz
...
<td>
 ...
 if ($kbilgi["stokgrupduzenle"]==1) {?>																
										<button  type="button" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-round btn-warning" data-original-title="Düzenle" onclick="window.location.href='StokGrupDuzenle.php?id=<?= $sonuc["id"] ?>'">
        ...
        $(document).ready(function(){
           ...
           var productId = $(this).data('id'); 	
				...
				swal({
                    ...
                    data: 'stokgrupsil='+productId, // Formdaki tüm verileri al
