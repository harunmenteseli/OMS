...
<head>
	...
	<title>Günlük Banka Giriş - Çıkış Detay - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title">GÜNLÜK BANKA GİRİŞ - ÇIKIŞ LİSTESİ</h4>
								</div>
...
<th>İşlem</th> 
   ...
   <?php $sorgu = $baglanti->query(" SELECT * FROM BankaGiris where DAY(islemtarihi) = DAY(CURDATE())")->fetchAll();
