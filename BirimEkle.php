...
<head>
	...
	<title>Birim Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="row">
 ...
 <input type="text" id="birimadi" class="form-control" placeholder="Birim Adı" name="birimadi" value="">
                                                  </div>
                                            </div>
                                            <!--/span-->
 ...
 <input type="text" id="kisaltma" class="form-control" placeholder="Kısaltma" name="kisaltma" value="">
                                                  </div>
                                            </div>
                                            <!--/span-->
