...
<head>
	...
	<title>Birimler - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
...
<div class="col-sm-9 col-md-9">
									...
									<h4 class="card-title">BİRİM LİSTESİ</h4>
								</div>
...
<button id="Kaydet" name="kaydet" type="submit" class="btn btn-success btn-raised btn-block" onclick="window.location.href='BirimEkle.php'">
Birim Ekle</button>
<?php }?>
<br>
...
<?php $sorgu = $baglanti->prepare('Select * from Birim'); // Veritabanındaki Depolar tablosundaki tüm verileri çekiyoruz
...
<tr id="secilen" class="Satirekle">
	      <td class="sira"><?= $sonuc['id']?></td>
                    <td class="birimadi"><?= $sonuc['birimadi']?></td>
...
<td>
 ...
 if ($kbilgi["birimduzenle"]==1) {?>															
										<button  type="button" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-round btn-warning" data-original-title="Düzenle" onclick="window.location.href='BirimDuzenle.php?id=<?= $sonuc["id"] ?>'">
        ...
        $(document).ready(function(){
           ...
           var productId = $(this).data('id'); 	
				...
				swal({
                    ...
                    data: 'birimsil='+productId, // Formdaki tüm verileri al
