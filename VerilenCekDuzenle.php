...
<head>
	...
	<title><?= $sonuc["ceknumarasi"] ?> Nolu Verilen Çeki Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $sonuc["ceknumarasi"] ?> Nolu Verilen Çeki Düzenle</h4>
								</div>
								<div class="card-body">
						<?php 
...
<label class="control-label">Evrak Türü</label>
	...
	Cirolu Evrak</option>
									...
									<input type="hidden" class="form-control" name="verilencekduzenle">
