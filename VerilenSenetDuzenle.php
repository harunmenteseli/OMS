...
<head>
	...
	<title><?= $sonuc["ceknumarasi"] ?> Nolu Verilen Seneti Düzenle - <?= $ayar["siteadi"] ?> - <?= $ayar["siteslogan"] ?></title>
	<?php
				...
				<div class="page-inner">
					...
					<div class="card">
								<div class="card-header">
									<h4 class="card-title"><?= $sonuc["ceknumarasi"] ?> Nolu Verilen Seneti Düzenle</h4>
								</div>
								<div class="card-body">
							<?php 
...
<label class="control-label">Evrak Türü</label>
      ...
      <option value="<?= $sonuc["evrakturu"] ?>">
		...
		<input type="hidden" class="form-control" name="verilensenetduzenle">
